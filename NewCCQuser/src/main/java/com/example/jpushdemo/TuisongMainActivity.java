...
public class TuisongMainActivity extends InstrumentedActivity implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tuisongmain);
		initView();   
	...
	public void onClick(View v) {
		...
		case R.id.init:
			...
			break;
		case R.id.setting:
			Intent intent = new Intent(TuisongMainActivity.this, PushSetActivity.class);
