...
import ccj.yun28.com.adapter.CcqZheKouJuanDetaillistAdapter;
 ...
 * 
 */
public class CcqProDetailActivity extends BaseActivity implements
		OnClickListener {
	// 商品图
	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case HANDLER_NET_FAILURE:
				dissDialog();
				Toast.makeText(CcqProDetailActivity.this, "当前网络不可用,请检查网络",
						Toast.LENGTH_SHORT).show();
				break;
			// 错误
			case HANDLER_NN_FAILURE:
				dissDialog();
				Toast.makeText(CcqProDetailActivity.this, "当前网络出错,请检查网络",
						Toast.LENGTH_SHORT).show();
				break;
			// 获取信息失败
			case HANDLER_GETINFO_FAILURE:
				dissDialog();
				Toast.makeText(CcqProDetailActivity.this,
			...
			case HANDLER_IS_VIP_SUCCESS:
				...
				if ("1".equals(msg.obj.toString().trim())) {
					...
					Toast.makeText(CcqProDetailActivity.this, "VIP才可以购买",
							Toast.LENGTH_SHORT).show();
					Intent intent = new Intent(CcqProDetailActivity.this,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View topView = LayoutInflater.from(CcqProDetailActivity.this).inflate(
				R.layout.activity_ccqprodetail, null);
		...
		ccqQuanLvAdapter = new CcqQuanLvAdapter(CcqProDetailActivity.this);
		...
		bitmapUtils = new BitmapUtils(CcqProDetailActivity.this);

		httpUtils = new HttpUtils();
		utils = new Utils();
		verstring = utils.getVersionInfo(CcqProDetailActivity.this);
		...
		int[] info = utils.getWindowInfo(CcqProDetailActivity.this);
		// 获取当前控件的布局对象
	...
	private void ccqprodetailHttpPost() {
		...
		// params.addBodyParameter("goods_id", "117485");

		// String member_id = "";
		// if (isLogin()) {
		// member_id = new DButil().getMember_id(CcqProDetailActivity.this);
		// }
	...
	protected void ccqprodetailListInfo(String result) {
		...
		try {
			...
			if ("200".equals(code)) {
				...
				if ("0.5".equals(ccqProInfoBean.getData().getGoods_teat())) {
					starsTest("1");
					...
					starsTest(ccqProInfoBean.getData().getGoods_teat());
				}
				if ("0.5".equals(ccqProInfoBean.getData().getGoods_info()
					...
					pingJiaStarsTest(ccqProInfoBean.getData().getGoods_info()
							.getEvaluation_good_star());
				}
	...
	private void ccqProQuanHttpPost() {
		...
		params.addHeader("ccq", utils.getSystemVersion() + "," + verstring[0]
				+ "," + verstring[2]);
		params.addBodyParameter("api_v", "v3");
		params.addBodyParameter("member_id", new DButil().getMember_id(CcqProDetailActivity.this));
		params.addBodyParameter("store_id", store_id);
		params.addBodyParameter("goodsr_id", ccqgoods_id);
		params.addBodyParameter("lat1", latitude);
		params.addBodyParameter("lng1", longitude);
		params.addBodyParameter("city_id", "");
//		params.addBodyParameter("narea_s_name", "");
		params.addBodyParameter("page", nowPage + "");
		httpUtils.send(HttpMethod.POST, JiekouUtils.NEWSQUANTUIJIAN, params,
				new RequestCallBack<String>() {
	...
	public void onClick(View v) {
		...
		case R.id.tv_yiyuan_buy:
			if (isLogin()) {
				...
				intent = new Intent(CcqProDetailActivity.this,
						LoginActivity.class);
				intent.putExtra("type", "qt");
				startActivity(intent);
			}
		...
		case R.id.line_pinjia:
			...
			break;
		case R.id.line_call:
			View view = LayoutInflater.from(CcqProDetailActivity.this).inflate(
			...
			dialog_text.setText("是否拨打： "
					+ ccqProInfoBean.getData().getStore_info()
							.getLive_store_tel());
			calldialog = new Dialog(CcqProDetailActivity.this,
		...
		case R.id.tv_phone_num:
			...
			if (ccqProInfoBean.getData().getStore_info().getLive_store_tel() != null
				...
				Toast.makeText(CcqProDetailActivity.this, "暂无电话",
						Toast.LENGTH_SHORT).show();
			}
			break;
	...
	private void sfVIPHttpPost() {
		...
		params.addBodyParameter("token",
				new DButil().gettoken(CcqProDetailActivity.this));
		params.addBodyParameter("member_id",
				new DButil().getMember_id(CcqProDetailActivity.this));
	...
	private void showShare() {
		ShareSDK.initSDK(CcqProDetailActivity.this, "171a7e7c3c736");
		...
		// 启动分享GUI
		oks.show(CcqProDetailActivity.this);
	}
	...
	private void pingJiaStarsTest(String num) {
		// TODO Auto-generated method stub
		int nu = Integer.parseInt(num);
		StarLayoutParams params = new StarLayoutParams();
		params.setNormalStar(getResources().getDrawable(R.drawable.starh))
	...
	private void showLoading() {
		...
		Animation animation = AnimationUtils.loadAnimation(
				CcqProDetailActivity.this, R.anim.loading_anim);
		image.startAnimation(animation);
		loadingDialog = new Dialog(CcqProDetailActivity.this,
				R.style.mDialogStyle);
