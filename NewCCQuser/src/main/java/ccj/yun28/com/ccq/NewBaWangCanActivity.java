 ...
 * 
 */
public class NewBaWangCanActivity extends BaseActivity implements OnClickListener,
		OnItemClickListener {
	private int page=1;
	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case HANDLER_NET_FAILURE:
				dissDialog();
				if (NewBaWangCanActivity.this != null) {

					Toast.makeText(NewBaWangCanActivity.this, "当前网络不可用,请检查网络",
			...
			case HANDLER_NN_FAILURE:
				...
				if (NewBaWangCanActivity.this != null) {
					...
					Toast.makeText(NewBaWangCanActivity.this, "系统异常，请稍后再试",
							Toast.LENGTH_SHORT).show();
				}
				break;
			case HANDLER_GETIONFO_FAILURE:
				...
				if (NewBaWangCanActivity.this != null) {
					...
					if (msg.obj != null) {
						Toast.makeText(NewBaWangCanActivity.this,
			...
			case HANDLER_CCQSHOPDETAI_SUCCESS:
				dissDialog();
				ccqStoreLvAdapter.NotifyList(ccqshopListdetaiList);
	...
	private NewBaWangCanActivity mActivity;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_bawangcan);
		this.mActivity = this;
...
//		ccqShopLvAdapter = new CcqShopLvAdapter(NewBaWangCanActivity.this);
		ccqStoreLvAdapter = new CcqStoreLvAdapter(NewBaWangCanActivity.this);
	...
	private void getStoreListHttpPost() {
		...
		String[] verstring = utils.getVersionInfo(NewBaWangCanActivity.this);
	...
	private void showLoading() {
		View view = LayoutInflater.from(NewBaWangCanActivity.this).inflate(
				R.layout.loading, null);
		ImageView image = (ImageView) view.findViewById(R.id.iv_loading);
		Animation animation = AnimationUtils.loadAnimation(
				NewBaWangCanActivity.this, R.anim.loading_anim);
		image.startAnimation(animation);
		loadingDialog = new Dialog(NewBaWangCanActivity.this, R.style.mDialogStyle);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position,
		...
		Intent intent = new Intent(NewBaWangCanActivity.this,
				CCQStoreDetailActivity.class);
//		Intent intent = new Intent(NewBaWangCanActivity.this,
//				NewCCQStoreDetailActivity.class);
	...
	private void initLocation() {
		// 初始化client
		locationClient = new AMapLocationClient(NewBaWangCanActivity.this
		...
		public void onLocationChanged(AMapLocation loc) {
			if (null != loc) {
				...
				if (loc.getErrorCode() == 0) {
					...
					// 定位失败
					Toast.makeText(NewBaWangCanActivity.this, "定位失败", Toast.LENGTH_SHORT)
							.show();
