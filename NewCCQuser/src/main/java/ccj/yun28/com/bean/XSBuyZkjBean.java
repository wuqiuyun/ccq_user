...
public class XSBuyZkjBean {
	...
	public String toString() {
		return "XSBuyZkjBean [address_info=" + address_info + ", freight_hash="
				+ freight_hash + ", goods_amount=" + goods_amount
				+ ", goods_freight=" + goods_freight + ", goods_freight_name="
				+ goods_freight_name + ", ifshow_offpay=" + ifshow_offpay
				+ ", inv_info=" + inv_info + ", order_amount=" + order_amount
