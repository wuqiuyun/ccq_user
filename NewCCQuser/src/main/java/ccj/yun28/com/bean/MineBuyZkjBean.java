...
public class MineBuyZkjBean {
	...
	private MineStoreInfo store_info;
	...
	public MineStoreInfo getStore_info() {
		return store_info;
	}
	public void setStore_info(MineStoreInfo store_info) {
	...
	public String toString() {
		return "MineBuyZkjBean [address_info=" + address_info
				...
				+ ", store_info=" + store_info + ", to_pay=" + to_pay + "]";
	}
}
