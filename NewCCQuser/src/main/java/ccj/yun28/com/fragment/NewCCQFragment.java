...
import ccj.yun28.com.adapter.WWCcqQuanSYLvAdapter;
 ...
 * 
 */
public class NewCCQFragment extends Fragment implements OnClickListener {
	private ListView lv;
	...
	private WWCcqQuanSYLvAdapter ccqQuanSYLvAdapter;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		View topView = LayoutInflater.from(getActivity()).inflate(
				R.layout.view_fragment_ccq_list_top, null);
		...
		ImageView iv_vip = (ImageView) topView.findViewById(R.id.iv_vip);
		ImageView iv_superquan = (ImageView) topView
				.findViewById(R.id.iv_superquan);
		ImageView iv_bawang = (ImageView) topView.findViewById(R.id.iv_bawang);
		// 美食
		RadioButton radio_quan = (RadioButton) topView
		...
		ccqQuanSYLvAdapter = new WWCcqQuanSYLvAdapter();
		...
		public void onLocationChanged(AMapLocation loc) {
			if (null != loc) {
				...
				if (loc.getErrorCode() == 0) {
					...
					String[] xxaddr = loc.getAddress().split("市");
					tv_now_place.setText(xxaddr[1]);
