 ...
 * 
 */
public class ShuRuNewPhone_yzmActivity extends BaseActivity implements
		OnClickListener {
	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case HANDLER_NET_FAILURE:
				dissDialog();
				Toast.makeText(ShuRuNewPhone_yzmActivity.this, "当前网络不可用,请检查网络",
						Toast.LENGTH_SHORT).show();
				break;
			// 错误
			case HANDLER_NN_FAILURE:
				dissDialog();
				Toast.makeText(ShuRuNewPhone_yzmActivity.this, "当前网络出错,请检查网络",
						Toast.LENGTH_SHORT).show();
				break;
			case HANDLER_GETINFO_FAILURE:
				dissDialog();
				if (msg.obj != null) {
					Toast.makeText(ShuRuNewPhone_yzmActivity.this,
			...
			case HANDLER_CHECKYZM_SUCCESS:
				dissDialog();
				Toast.makeText(ShuRuNewPhone_yzmActivity.this, "关联成功",
						Toast.LENGTH_SHORT).show();
			...
			case HANDLER_TOKEN_FAILURE:
				...
				Intent lointent = new Intent(ShuRuNewPhone_yzmActivity.this,
						LoginActivity.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_shurunewphone_yzm);
		...
		TextView tv_bangding = (TextView) findViewById(R.id.tv_bangding);

		bitmapUtils = new BitmapUtils(ShuRuNewPhone_yzmActivity.this);
		httpUtils = new HttpUtils();
		utils = new Utils();
		verstring = utils.getVersionInfo(ShuRuNewPhone_yzmActivity.this);
	...
	private void checkNeedPicHttpPost() {
		...
		params.addBodyParameter("member_id",
				new DButil().getMember_id(ShuRuNewPhone_yzmActivity.this));
		...
		case R.id.tv_getyzm:
			...
			if (isneedpic) {
				if (et_picyzm.getText().toString().trim().length() != 4) {
					...
					Toast.makeText(ShuRuNewPhone_yzmActivity.this, "图片验证码错误",
							Toast.LENGTH_SHORT).show();
				} else if (et_phone.getText().toString().trim().length() < 11) {
					et_phone.setFocusable(true);
					Toast.makeText(ShuRuNewPhone_yzmActivity.this, "手机号码错误",
							Toast.LENGTH_SHORT).show();
	...
	private void bangDingHttpPost() {
		...
		params.addBodyParameter("token",
				new DButil().gettoken(ShuRuNewPhone_yzmActivity.this));
	...
	private boolean canPost() {
		...
		if (TextUtils.isEmpty(phonenum)) {
			et_phone.setFocusable(true);
			Toast.makeText(ShuRuNewPhone_yzmActivity.this, "手机号码不能为空",
					Toast.LENGTH_SHORT).show();
			return false;
		} else if (phonenum.length() != 11) {
			et_phone.setFocusable(true);
			Toast.makeText(ShuRuNewPhone_yzmActivity.this, "手机号码格式不对",
					Toast.LENGTH_SHORT).show();
			return false;
		} else if (TextUtils.isEmpty(yzmnum)) {
			tv_getyzm.setFocusable(true);
			Toast.makeText(ShuRuNewPhone_yzmActivity.this, "验证码不能为空",
					Toast.LENGTH_SHORT).show();
			return false;
		} else if (yzmnum.length() > 8) {
			et_yzm.setFocusable(true);
			Toast.makeText(ShuRuNewPhone_yzmActivity.this, "验证码错误",
					Toast.LENGTH_SHORT).show();
			return false;
	...
	private void showLoading() {
		View view = LayoutInflater.from(ShuRuNewPhone_yzmActivity.this)
				.inflate(R.layout.loading, null);
		ImageView image = (ImageView) view.findViewById(R.id.iv_loading);
		Animation animation = AnimationUtils.loadAnimation(
				ShuRuNewPhone_yzmActivity.this, R.anim.loading_anim);
		image.startAnimation(animation);
		loadingDialog = new Dialog(ShuRuNewPhone_yzmActivity.this,
