...
import ccj.yun28.com.neworder.RecommendAdapter;
 ...
 * 待付款
 */
public class MyNoPayFragment extends Fragment {
...
//						Log.e("log", "待付款->order: " + "size:"+order.getData().size()+"\n"+order.toString());
