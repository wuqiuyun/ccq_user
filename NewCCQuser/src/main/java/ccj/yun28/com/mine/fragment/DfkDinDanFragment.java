...
import ccj.yun28.com.adapter.DfkDinDanAdapter.DinDanDateListener;
 ...
 * 
 */
public class DfkDinDanFragment extends Fragment implements OnScrollListener,
		OnItemClickListener, DinDanDateListener {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		dfkDinDanAdapter = new DfkDinDanAdapter(getActivity());
		lv.setAdapter(dfkDinDanAdapter);
		dfkDinDanAdapter.setDinDanDateListener(this);
		flag = true;
		showLoading();
		dfkDinDanHttpPost();
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position,
		...
		if ("0".equals(dfkDinDanAdapter.getData().get(position).getUnion_type())) {
			...
			intent.putExtra("order_id", dfkDinDanAdapter.getData()
					.get(position).getOrder_id());
			startActivityForResult(intent, 100);
		} else if ("3".equals(dfkDinDanAdapter.getData().get(position)
				.getUnion_type())) {
			intent = new Intent(getActivity(), CCQDinDanDetailActivity.class);
			intent.putExtra("order_id", dfkDinDanAdapter.getData()
					.get(position).getOrder_id());
			startActivityForResult(intent, 200);
		} else if ("2".equals(dfkDinDanAdapter.getData().get(position)
				.getUnion_type())) {
			intent = new Intent(getActivity(),
