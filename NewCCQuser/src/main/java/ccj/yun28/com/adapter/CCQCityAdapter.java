...
import ccj.yun28.com.bean.ccq.QuInfobean;
 ...
 * @author meihuali
 */
public class CCQCityAdapter extends BaseAdapter {
	private Context context;
	// private List<Map<String, String>> list;
	private List<QuInfobean> data;
	private HashMap<Integer, View> temp = new HashMap<Integer, View>();

	public CCQCityAdapter(Activity context) {
		this.context = context;
		// this.list = new ArrayList<Map<String, String>>();
		this.data = new ArrayList<QuInfobean>();
	...
	public void NotifyList(List<QuInfobean> data) {
