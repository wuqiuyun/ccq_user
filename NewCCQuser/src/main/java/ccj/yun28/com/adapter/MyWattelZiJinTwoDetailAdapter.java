 ...
 * @author meihuali
 */
public class MyWattelZiJinTwoDetailAdapter extends BaseAdapter {
	private Context context;
	private List<Map<String, String>> list;
	private HashMap<Integer, View> temp = new HashMap<Integer, View>();

	public MyWattelZiJinTwoDetailAdapter(Activity context) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.tv_two.setText(list.get(position).get("value_name"));
