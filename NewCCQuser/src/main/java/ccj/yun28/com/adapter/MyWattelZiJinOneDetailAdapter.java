 ...
 * @author meihuali
 */
public class MyWattelZiJinOneDetailAdapter extends BaseAdapter {
	private Context context;
	private List<Map<String, String>> list;
	private HashMap<Integer, View> temp = new HashMap<Integer, View>();

	public MyWattelZiJinOneDetailAdapter(Activity context) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.tv_one.setText(list.get(position).get("order_sn"));
		holder.tv_two.setText(list.get(position).get("info"));
		holder.tv_three.setText(list.get(position).get("value_name"));
		holder.tv_four.setText(list.get(position).get("time"));
