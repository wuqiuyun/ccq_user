	...
	public View getChildView(final int groupPosition, final int childPosition,
		...
		if (convertView == null) {
			...
			cholder.tv_product_desc = (TextView) convertView
					.findViewById(R.id.tv_intro);// 商品名
			cholder.tv_price = (TextView) convertView
					.findViewById(R.id.tv_price);// 价格
			cholder.iv_increase = (TextView) convertView
					.findViewById(R.id.tv_add);// 加
			cholder.iv_decrease = (TextView) convertView
					.findViewById(R.id.tv_reduce);// 减
			cholder.tv_count = (TextView) convertView.findViewById(R.id.tv_num);// 数字
		...
		if (product != null) {
			...
			bitmapUtils.display(cholder.iv_adapter_list_pic,
					product.getImageUrl());
