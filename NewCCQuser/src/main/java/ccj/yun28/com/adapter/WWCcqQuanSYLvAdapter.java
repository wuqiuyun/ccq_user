 ...
 * @author meihuali
 */
public class WWCcqQuanSYLvAdapter extends BaseAdapter {
	private Activity context;
	private String latitude;
	private String longitude;
	private List<Map<String, String>> list;
	private List<Map<String, String>> cityInfo;
	...
	public void CcqQuanSYLvAdapter(Activity context) {
	...
	public void setCityInfo(List<Map<String, String>> cityInfo){
		this.cityInfo.clear();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		goods_id = list.get(position).get("goods_id");
		holder.real_pic.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(context, CcqProDetailActivity.class);
				intent.putExtra("starlat", list.get(position).get("latitude"));
				intent.putExtra("starlng", list.get(position).get("longitude"));
				intent.putExtra("ccqgoods_id", list.get(position).get("goods_id"));
				intent.putExtra("store_id", list.get(position).get("store_id"));
				intent.putExtra("city", cityInfo.get(0).get("city"));
				intent.putExtra("district", cityInfo.get(0).get("district"));
				context.startActivity(intent);
			}
		});
