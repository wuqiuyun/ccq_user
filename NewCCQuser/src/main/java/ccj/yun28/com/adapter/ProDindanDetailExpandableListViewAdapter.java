...
public class ProDindanDetailExpandableListViewAdapter extends
	 ...
	 * @param context
	 */
	public ProDindanDetailExpandableListViewAdapter(List<GroupInfo> groups,
	...
	public View getGroupView(final int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			...
			convertView = View.inflate(context,
					R.layout.item_dindandetail_group, null);
	...
	public View getChildView(final int groupPosition, final int childPosition,
		...
		if (convertView == null) {
			...
			convertView = View.inflate(context,
					R.layout.item_dindandetail_product, null);
			...
			cholder.tv_pro_num = (TextView) convertView
		...
		if (product != null) {
			...
			bitmapUtils.display(cholder.iv_adapter_list_pic, product.getImageUrl());
			cholder.tv_product_desc.setText(product.getDesc());
			cholder.tv_price.setText("¥" + product.getPrice() + "");
			cholder.tv_pro_num.setText(product.getCount()+"");
		}
		return convertView;
	}
